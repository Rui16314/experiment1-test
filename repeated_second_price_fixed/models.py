...
class C(BaseConstants): NAME_IN_URL='repeated_second_price_fixed'; PLAYERS_PER_GROUP=2; NUM_ROUNDS=10; BID_SECONDS=60; MAX_V=10000; MIN_V=0
...
def set_payoffs(group:Group): set_bids_and_outcomes(group, price_rule='second')
